        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">contact@bloodbankpro.com</p>
            ...
            <Card className="bg-destructive text-destructive-foreground">
              ...
              <CardContent>
                <p className="mb-4">For urgent blood requirements, please call our 24/7 emergency hotline:</p>
                <p className="text-2xl font-bold mb-2">+91 1800-EMERGENCY</p>
                <p className="text-sm opacity-90">Available round the clock for critical situations</p>
              </CardContent>
            </Card>
          </div>
        </div>
